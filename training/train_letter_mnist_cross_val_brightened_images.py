...
from brightness_offset_lettermnist import load_letter_mnist_with_positive_brightness_offset


with tf.device('GPU:0'):
    print("EMNIST/Letters adj (positive)")
    ...
    experiment = "no_bias_gaussian_weights_128_adj" # TODO: make sure this folder exists in dt{dt} and dt{dt}_untrained
    ...
    for decay_distribution in decay_initializers:
        ...
        for t_dec in decays:
            ...
            train_fold, val_fold, test_set = load_letter_mnist_with_positive_brightness_offset(num_folds)
